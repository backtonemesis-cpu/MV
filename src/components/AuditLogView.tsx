...
export const AuditLogView: React.FC<AuditLogViewProps> = ({ auditLogs }) => {
  ...
  return (
    <div className="space-y-4 pb-12">
      ...
      <div className="bg-white p-4 rounded-2xl border border-neutral-200 shadow-xs flex flex-col sm:flex-row gap-3">
            ...
            {filteredLogs.map((entry) => (
              <div key={entry.id} className="p-4 hover:bg-neutral-50/70 transition">
                ...
                {entry.details && Object.keys(entry.details).length > 0 && (
                  <div className="mt-2.5 p-2 bg-neutral-50 rounded-lg text-[10px] font-mono text-neutral-600 border border-neutral-100 overflow-x-auto">
